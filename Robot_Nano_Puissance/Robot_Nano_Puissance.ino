...
#define PWM_OUTPUT_MOTOR_L 9 // Pin 6 où sort le pwm du moteur 2
#define INPUT_4_MOTOR_L    2  // Pin 9 pour un sens
#define INPUT_3_MOTOR_L    3  // Pin 8 pour l'autre sens

#define PWM_OUTPUT_MOTOR_R 10 // Pin 10 où sort le pwm du moteur 1
#define INPUT_2_MOTOR_R    5  // Pin 5 pour un sens
#define INPUT_1_MOTOR_R    8  // Pin 4 pour l'autre sens
